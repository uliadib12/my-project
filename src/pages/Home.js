    ...
    <>  
        ...
        <div className="bg-gray-100 min-h-screen">
            <div className="body">
                ...
                <div className="bg-white border-2 mt-4 ml-7 p-3 mb-10">
